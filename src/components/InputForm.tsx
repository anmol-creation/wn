...
import { CATEGORY_OPTIONS, EDUCATION_LEVELS, SKILL_LEVELS, HOBBY_LEVELS, INTEREST_LEVELS, ACTIVITY_LEVELS, SPENDING_LEVELS, type HierarchicalOption } from '../data/options';
